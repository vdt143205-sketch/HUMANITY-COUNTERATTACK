...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, cwidth, speed, vwidth, screen, height):
        ...
        self.image = pygame.transform.scale(self.image0, (30, 15))
    ...
    def read_fingers(self):
        ...
        # cvzone bản mới trả về: hands, img
        hands, img = self.detector.findHands(img, draw=False, flipType=False)
        ...
        if hands:
            ...
            mapped_x = x1 - 100
            mapped_x = mapped_x * (self.max_x_constraint - self.vwidth)
            mapped_x = mapped_x // 1150

            self.rect.x = mapped_x + self.vwidth
